...
What should be noticed about this sampling distribution is that the confidence interval does not contain zero, meaning that the average treatment effect for 95% of the data shows a positive difference between incumbency and the likelihood for a republican representative to be decisive on their opinion regarding the validity of the 2020 election. Thus, the sampling distribution of the average treatment effects prove statistical signficance between the two variables, though it is important to note that important confounders, such as geography have not been considered. 
