...
e3 <- e2|>  
  ...
  ggplot(aes(x = Incumbent, y = mean)) + geom_col(ylim=c(0,2), fill = "steelblue1") + labs(
    x = "Incumbent",
    y = "Percent of Decisive Candidates",
    title = "Incumbency and outspoken, decisive positioning on 2016 election validity"
  )
